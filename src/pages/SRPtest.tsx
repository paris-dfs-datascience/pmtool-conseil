...
const ScriptRunnerPage: React.FC<ScriptRunnerPageProps> = () => {
  ...
  const runScript = async (): Promise<void> => {
    ...
    try {
      ...
      const response = await fetch('https://document-processor-test-443545551926.us-central1.run.app/process', {
        method: 'POST',
        body: formData
      });
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <h1 className="text-2xl font-bold text-gray-900">NPA Test Executive Voice Tool</h1>
