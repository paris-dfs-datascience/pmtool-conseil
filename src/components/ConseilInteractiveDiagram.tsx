...
const InteractiveLMADiagram = () => {
  ...
  const ProcessStep = ({ title, icon: Icon, index, isActive }: {
    ...
    <div
      className={`relative px-4 py-3 rounded-lg cursor-pointer transition-all duration-300 transform ${
        isActive
  ...
  const DataSource = ({ icon: Icon, label }: {
    ...
    <div
      className="flex flex-col items-center p-3 bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:scale-105"
      onMouseEnter={(e) => handleMouseEnter(label, e)}
      onMouseLeave={handleMouseLeave}
    >
      <Icon size={28} className="text-gray-600 mb-2" />
    ...
    <div className="w-full max-w-7xl mx-auto p-6 bg-gradient-to-br from-slate-50 to-blue-50 rounded-xl shadow-xl">
      ...
      <div className="text-center mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-1">
          Leveraging AI to uncover data driven insights and opportunities
        </h1>
      </div>
      ...
      <div className="grid grid-cols-12 gap-4">
        ...
        <div className="col-span-2">
          <h3 className="text-base font-semibold text-gray-700 mb-3">Data Sources</h3>
        ...
        <div className="col-span-8">
          ...
          <div className="bg-gray-200 rounded-xl p-4 mb-4">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-bold text-gray-800">AI Assisted Process Flow</h2>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div
              className="bg-white rounded-lg p-3 shadow-md hover:shadow-lg transition-shadow duration-300 cursor-pointer"
              onMouseEnter={(e) => handleMouseEnter('Human Analysis', e)}
              onMouseLeave={handleMouseLeave}
            >
              <div className="flex items-center space-x-2 mb-1">
                <Users size={18} className="text-blue-600" />
                <span className="font-medium text-sm text-gray-800">Human Analysis</span>
              </div>
              <div className="text-xs text-gray-600">Expert review and validation</div>
            </div>
            ...
            >
              <div className="flex items-center space-x-2 mb-1">
                ...
                <span className="font-medium text-sm text-gray-800">NLP & Predictive Analytics</span>
              </div>
            ...
            >
              <div className="flex items-center space-x-2 mb-1">
                ...
                <span className="font-medium text-sm text-gray-800">Expert & Past Experience</span>
              </div>
              <div className="text-xs text-gray-600">Historical context and expertise</div>
            </div>
          </div>
