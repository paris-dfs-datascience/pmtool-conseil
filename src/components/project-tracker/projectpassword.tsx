// src/components/project-tracker/projectpassword.tsx
import React, { useState } from 'react';
import { Lock } from 'lucide-react';

const PROJECT_PASSWORD = 'lmaprofit';

interface Props {
  children: React.ReactNode;
}

export default function ProjectPasswordGate({ children }: Props) {
  ...
  return (
    <div className="flex items-center justify-center h-full bg-gray-50">
      <div className="bg-white rounded-xl shadow-md p-8 w-full max-w-sm text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-800 mb-1">Project Tracker</h2>
