...
# Create router WITHOUT prefix since we want routes to be directly under /github
router = APIRouter(tags=["GitHub Assistant"])

# Configuration - hardcoded values
PROJECT_ID = os.getenv("PROJECT_ID", "lma-website-461920")
REGION = "us-central1"  # Hardcoded
MODEL = "codestral-2501"  # Hardcoded
        ...
        try:
            ...
            if not all([PROJECT_ID, REGION, MODEL]):
                raise GitHubConfigurationError(
                    ...
                    missing_config="PROJECT_ID, REGION, or MODEL"
                )
